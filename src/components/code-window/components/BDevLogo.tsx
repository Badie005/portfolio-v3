...
export function BDevLogo({ width = 140, height = 180, className }: { width?: number, height?: number, className?: string }) {
    return (
        <svg width={width} height={height} viewBox="0 0 969 1257" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
            ...
            <defs>
                <clipPath id="clip0_157_959">
                    <rect width="969" height="1257" fill="white" />
                </clipPath>
                <clipPath id="clip1_157_959">
                    <rect width="969" height="1257" fill="white" />
                </clipPath>
            </defs>
        </svg>
