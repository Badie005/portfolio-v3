...
export function useTerminal({ files, onOpenFile }: UseTerminalOptions) {
    const [history, setHistory] = useState<TerminalMessage[]>([
        { type: 'output', content: `${ansi.bold}B.DEV Terminal${ansi.reset} [Version 2.0.0]` },
        ...
        help: {
            ...
            execute: (args) => {
                ...
                return [
                    ...
                    { type: 'output', content: `│    ${ansi.cyan}ls${ansi.reset} [-la]        List directory contents                  │` },
                    { type: 'output', content: `│    ${ansi.cyan}cd${ansi.reset} <dir>        Change directory                         │` },
                    { type: 'output', content: `│    ${ansi.cyan}pwd${ansi.reset}             Print working directory                  │` },
                    { type: 'output', content: `│    ${ansi.cyan}tree${ansi.reset}            Display directory tree                   │` },
                    { type: 'output', content: `│    ${ansi.cyan}find${ansi.reset} <pattern>  Search for files                         │` },
                    { type: 'output', content: `├${ansi.gray}─────────────────────────────────────────────────────────────${ansi.reset}┤` },
                    { type: 'output', content: `│  ${ansi.bold}FILE OPERATIONS${ansi.reset}                                            │` },
                    { type: 'output', content: `│    ${ansi.cyan}cat${ansi.reset} <file>      Display file contents                    │` },
                    { type: 'output', content: `│    ${ansi.cyan}open${ansi.reset} <file>     Open file in editor                      │` },
                    { type: 'output', content: `│    ${ansi.cyan}head${ansi.reset} <file>     Show first 10 lines                      │` },
                    { type: 'output', content: `│    ${ansi.cyan}tail${ansi.reset} <file>     Show last 10 lines                       │` },
                    { type: 'output', content: `│    ${ansi.cyan}wc${ansi.reset} <file>       Word/line count                          │` },
                    { type: 'output', content: `│    ${ansi.cyan}grep${ansi.reset} <pat> <f>  Search in file                           │` },
                    { type: 'output', content: `├${ansi.gray}─────────────────────────────────────────────────────────────${ansi.reset}┤` },
                    { type: 'output', content: `│  ${ansi.bold}SYSTEM${ansi.reset}                                                     │` },
                    { type: 'output', content: `│    ${ansi.cyan}whoami${ansi.reset}          Current user                             │` },
                    { type: 'output', content: `│    ${ansi.cyan}date${ansi.reset}            Current date/time                        │` },
                    { type: 'output', content: `│    ${ansi.cyan}uptime${ansi.reset}          System uptime                            │` },
                    { type: 'output', content: `│    ${ansi.cyan}env${ansi.reset}             Environment variables                    │` },
                    { type: 'output', content: `│    ${ansi.cyan}export${ansi.reset} K=V      Set environment variable                 │` },
                    { type: 'output', content: `│    ${ansi.cyan}echo${ansi.reset} <text>     Print text                               │` },
                    { type: 'output', content: `│    ${ansi.cyan}history${ansi.reset}         Command history                          │` },
                    { type: 'output', content: `│    ${ansi.cyan}alias${ansi.reset} [n=cmd]   Manage aliases                           │` },
                    { type: 'output', content: `├${ansi.gray}─────────────────────────────────────────────────────────────${ansi.reset}┤` },
                    { type: 'output', content: `│  ${ansi.bold}DEV TOOLS${ansi.reset}                                                  │` },
                    { type: 'output', content: `│    ${ansi.cyan}npm${ansi.reset} <cmd>       NPM commands (start/build/test/install)  │` },
                    { type: 'output', content: `│    ${ansi.cyan}node${ansi.reset} -v         Node.js version                          │` },
                    { type: 'output', content: `│    ${ansi.cyan}git${ansi.reset} <cmd>       Git commands (status/log/branch)         │` },
                    { type: 'output', content: `│    ${ansi.cyan}curl${ansi.reset} <url>      Fetch URL (simulated)                    │` },
                    { type: 'output', content: `│    ${ansi.cyan}ping${ansi.reset} <host>     Ping host (simulated)                    │` },
                    { type: 'output', content: `├${ansi.gray}─────────────────────────────────────────────────────────────${ansi.reset}┤` },
                    { type: 'output', content: `│  ${ansi.bold}UTILITIES${ansi.reset}                                                  │` },
                    { type: 'output', content: `│    ${ansi.cyan}clear${ansi.reset} / cls     Clear terminal                           │` },
                    { type: 'output', content: `│    ${ansi.cyan}neofetch${ansi.reset}        System info                              │` },
                    { type: 'output', content: `│    ${ansi.cyan}cowsay${ansi.reset} <msg>    ASCII cow says message                   │` },
                    { type: 'output', content: `│    ${ansi.cyan}matrix${ansi.reset}          Matrix rain effect                       │` },
                    { type: 'output', content: `│    ${ansi.cyan}calc${ansi.reset} <expr>     Calculator                               │` },
                    { type: 'output', content: `│    ${ansi.cyan}snake${ansi.reset}           Play Snake game                          │` },
                    { type: 'output', content: `╰${ansi.gray}─────────────────────────────────────────────────────────────${ansi.reset}╯` },
