        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight mb-6">
              <span className="text-brand">Mes </span>
              <span className="text-ide-accent">Projets</span>
            </h1>

            {/* Subtitle - Enhanced */}
            <div className="max-w-2xl">
              <p className="text-lg lg:text-xl text-ide-muted leading-relaxed mb-5">
                Du concept à la production — des applications web qui résolvent
                de <span className="text-brand font-medium">vrais problèmes</span> avec
                des <span className="text-brand font-medium">résultats mesurables</span>.
              </p>
          ...
          {/* CTA Section - Developer/Terminal Theme */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            ...
            <div className="relative p-8 md:p-12 rounded-2xl bg-surface-2 dark:bg-[#121212] border border-ide-border overflow-hidden text-neutral-900 dark:text-neutral-100">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="text-left space-y-4 max-w-2xl">
                  <TerminalStatus
                    texts={["~/portfolio/contact", "Initializing connection...", "Ready to collaborate"]}
                  ...
                  <div className="font-mono text-sm text-neutral-500 dark:text-neutral-400 bg-white dark:bg-black/20 px-4 py-2 rounded border border-neutral-200 dark:border-white/10 inline-block">
                    <span className="text-green-500">$</span> git checkout -b <span className="text-ide-accent">new-collaboration</span>
                  </div>
                </div>
